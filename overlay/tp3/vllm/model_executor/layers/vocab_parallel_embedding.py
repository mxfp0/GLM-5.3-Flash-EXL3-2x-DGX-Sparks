...
class VocabParallelEmbedding(PluggableLayer):
    ...
    def __init__(
        ...
        *,
        ...
        # TP=3: default pad_to=64 leaves 154880 unchanged, but 154880%3!=0.
        # Bump padding_size to lcm(pad, tp) so both the main model and the
        # MTP draft embedding divide cleanly.
